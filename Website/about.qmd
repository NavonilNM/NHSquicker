...
<span style="color:#2b6f73; letter-spacing:0.12em; font-size:0.85em; font-weight:600;">
DIGITAL URGENT CARE DECISION SUPPORT
</span>
...
<strong>Choose Right Service</strong><br>
...
::: {style="background:white; padding:25px; border-radius:18px; box-shadow:0 8px 20px rgba(0,0,0,0.06);"}
<strong>Reduce Overcrowding</strong><br>
...
::: {style="background:white; padding:25px; border-radius:18px; box-shadow:0 8px 20px rgba(0,0,0,0.06);"}
<strong>Support urgent-care network</strong><br>
...
NHSquicker is a collaboration between the University of Exeter, NHS organisations across Devon, Cornwall and Somerset, and system integration partners.
