...
NHSquicker uses live and near-real-time data provided by NHS trusts across the South West. The list below shows which organisations and services currently supply data to the app.

::::: {style="display:flex; flex-wrap:wrap; gap:2rem; align-items:flex-start;"}
<!-- Left column: list of services -->

::: {style="flex:1 1 320px; min-width:300px; margin-top: 3rem;"}
<details>
...
::: {style="flex:1.4 1 420px; min-width:400px; align-self:flex-start; margin-top: 3rem; margin-bottom: 10rem;"}
![](Rplot08.png){width="100%" style="display:block; border-radius:0px; box-shadow:0 2px 8px rgba(0,0,0,0.08);"}
:::
:::::

## Data process {#data-process}

This map shows how real-time data sent from NHS trusts is then sent to NHSquicker, and then to the app for people to view.

::: {style="text-align: center;"}
<img src="DAS_architecture.png" style="max-width:600px; width:100%;"/>
:::
